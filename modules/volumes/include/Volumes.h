...
#define MODULES_VOLUMES_INCLUDE_VOLUMES_H_
 ...
 const double& Side3);
    double TruncatedCylinder(const double& BigHeight,
 ...
 const double& InnerRadius, const double& Height);
 ...
 const double& MajorSemiaxis, const double& SmallSemiaxis);
    double EllipticalCylinder(const double& Height,
 const double& MajorSemiaxis, const double& SmallSemiaxis);
 ...
 const double& DescribedSphereRadius);
    ...
    double TruncatedPyramid(const double& Height,
 const double& BigSquare, const double& SmallSquare);
