...
TEST(Shokurov_Daniil_EulerFunctionTest, big_number_test1) {
  // Arrange
  int64_t expected, actual;
  // Act
...
TEST(Shokurov_Daniil_EulerFunctionTest, big_number_test2) {
  // Arrange
  int64_t expected, actual;
  // Act
...
TEST(Shokurov_Daniil_EulerFunctionTest, big_number_test3) {
  // Arrange
  int64_t expected, actual;
  // Act
...
TEST(Shokurov_Daniil_EulerFunctionTest, big_number_test4) {
  // Arrange
  int64_t expected, actual;
  // Act
...
TEST(Shokurov_Daniil_EulerFunctionTest, big_number_test5) {
  // Arrange
  int64_t expected, actual;
  // Act
...
TEST(Shokurov_Daniil_EulerFunctionTest, random_test1) {
  // Arrange
  int64_t expected, actual;
  // Act
  expected = 47974320;
...
TEST(Shokurov_Daniil_EulerFunctionTest, random_test2) {
  // Arrange
  int64_t expected, actual;
  // Act
  expected = 5391360;
...
TEST(Shokurov_Daniil_EulerFunctionTest, random_test3) {
  // Arrange
  int64_t expected, actual;
  // Act
  expected = 80307498;
...
TEST(Shokurov_Daniil_EulerFunctionTest, random_test4) {
  // Arrange
  int64_t expected, actual;
  // Act
  expected = 29948288;
...
TEST(Shokurov_Daniil_EulerFunctionTest, random_test5) {
  // Arrange
  int64_t expected, actual;
  // Act
  expected = 27516120;
