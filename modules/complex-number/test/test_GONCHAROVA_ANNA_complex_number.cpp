...
TEST(Goncharova_Anna_ComplexNumberTest, hypotenuse_and_legs) {
double re1 = 3.0;
double im1 = 4.0;
double re2 = 5.0;
double im2 = 12.0;
...
TEST(Goncharova_Anna_ComplexNumberTest, equal) {
...
TEST(Goncharova_Anna_ComplexNumberTest, not_equal) {
