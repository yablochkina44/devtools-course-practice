...
double ComplexNumber::getRe() const { return real_; }

double ComplexNumber::getIm() const { return imaginary_; }

void ComplexNumber::setRe(const double real) { real_ = real; }

void ComplexNumber::setIm(const double imaginary) { imaginary_ = imaginary; }
...
ComplexNumber ComplexNumber::operator*(const ComplexNumber& z) const {
  ...
  multiplication.setRe(this->getRe() * z.getRe() - this->getIm() * z.getIm());
  multiplication.setIm(this->getRe() * z.getIm() + this->getIm() * z.getRe());

  return multiplication;
}

bool ComplexNumber::equalsZero(const ComplexNumber& z) const {
  return z.getRe() < eps && z.getRe() > -eps && z.getIm() < eps &&
         z.getIm() > -eps;
}
...
double ComplexNumber::argument() const { return atan2(getIm(), getRe()); }
